...
DROP TABLE `mytempHanimlar`;


create table mytempHanimlar
select * from Nefer WHERE gender = 'F';
...
/* SATIS YAPAN PERSONEL, BU CUSTOMER'A HANGI SALES REPRESENTATIVE ULASMIS */
salesRepEmployee

/* POINT SYSTEM, BONUS SYSTEM, MUKAFAT */
SELECT COUNT(*) FROM `customer` WHERE salesRepEmployee = 12;
/* 12 numarali EMPLOYEE, KAC TANE CUSTOMER'a ULASTI */
/* COUNT=400, Her bir customer icin, 1 MANAT */
/* WHERE DEN SONRA SIKLIKLA KULLANILAN COLUMN'LARA, KEY VERILIR = INDEX!!
	AMAC: DAHA HIZLI SORGU (SELECT)
 */
